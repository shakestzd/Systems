...
id: DD-001
focus: "Capital Reality"
question: "How much of announced AI capex actually converts to physical infrastructure, and what persists if the demand thesis fails?"
arc: "Commit→Convert→Land"
---
...
Six companies spent $${stats.capex_2025.toFixed(0)}B on capital expenditure in 2025, up from $${stats.capex_2024.toFixed(0)}B the year before. Three of them have run cloud infrastructure businesses for over a decade. AWS, Google Cloud, and Azure earned $${stats.cloud_rev_2025.toFixed(0)}B combined last year. The other three don't report an equivalent revenue segment. Every CEO who addressed the increase pointed to the same thing. Sundar Pichai, February 2025: "${stats.pichai_underinvest_quote}" Mark Zuckerberg, January 2025: "${stats.zuckerberg_capacity_quote}" Satya Nadella, January 2025: "${stats.nadella_demand_supply_quote}" No company discloses what AI specifically earns.
